...
replace github.com/zmoog/otel-collector-contrib/receiver/wavinsentioreceiver v0.120.0 => ../../receiver/wavinsentioreceiver

replace github.com/zmoog/otel-collector-contrib/receiver/zcsazzurroreceiver v0.120.0 => ../../receiver/zcsazzurroreceiver
